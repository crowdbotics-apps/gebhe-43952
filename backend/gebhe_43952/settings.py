"""
Django settings for gebhe_43952 project.
...
WSGI_APPLICATION = 'gebhe_43952.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gebhe_43952 API",
    "DESCRIPTION": "API documentation for gebhe_43952 App",
    "VERSION": "v1",
}
